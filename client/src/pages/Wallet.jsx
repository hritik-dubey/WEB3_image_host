...
import {connetWallet}  from "../utils/connectWallet.js";
import { useNavigate } from 'react-router-dom';
import { useEffect } from "react";

export function Wallet() {
    const navigateTo=useNavigate()
    let {web3State, updateWeb3State} = useWb3context();
    ...
    const handleWalletConnection = async ()=>{
        const {contractInstance, selectedAccount} =  await connetWallet();
    ...
    return (
        <div
            ...
            <div
                className="absolute bottom-0 left-0 right-0 top-0 bg-[radial-gradient(circle_500px_at_50%_200px,#C9EBFF,transparent)] flex flex-col justify-center items-center gap-20">
